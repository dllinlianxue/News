<?php if (!defined('THINK_PATH')) exit(); $navs = D("Menu")->getBarMenus(); ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
      ...
      <div class="col-sm-9 col-md-9">
        <div class="banner">
          ...
          <div class="banner-right">
            <ul>
              <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--result['topSmailNews']-->
              <li>
        ...
        <div class="news-list">
          <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--result['listNews']-->
          <dl>
